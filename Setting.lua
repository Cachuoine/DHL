...
UserInputService.InputBegan:Connect(function(
    ...
    if input.KeyCode ==
    HotkeyConfig.Key then


        local gui =
        Players.LocalPlayer.PlayerGui:FindFirstChild(
            "FishHub"
        )
